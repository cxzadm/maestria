...
\begin{ganttchart}[
    hgrid,
    vgrid,
    x unit=0.1cm, % Ajusta este valor según tu preferencia
    ...
    bar/.append style={draw=none, fill=blue!50}, % Estilo de las barras
    ...
    \ganttbar{Reuniones semanales}{2023-10-07}{2023-12-02} \\
    \ganttbar{Revisión intermedia}{2023-11-18}{2023-11-18} \\
    \ganttbar{Presentación final}{2023-12-02}{2023-12-02} \\
\end{ganttchart}
